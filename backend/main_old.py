...
app = FastAPI(
    title="NIRBHAYA API - Route Clustering & IPFS Blockchain",
...
# ---------------------------
# Include IPFS & Blockchain Router
# ---------------------------
try:
    from routes.ipfs_blockchain import router as ipfs_router
    app.include_router(ipfs_router)
    logging.info("✅ IPFS & Blockchain router loaded")
except ImportError as e:
    logging.warning(f"⚠️ IPFS router not loaded: {e}")
except Exception as e:
    logging.error(f"❌ Error loading IPFS router: {e}")
