...
const MyMap: React.FC = () => {
  ...
  const { isLoaded } = useJsApiLoader({
    ...
    googleMapsApiKey: hasGoogleMapsKey ? process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY as string : "",
        ...
        <div className="flex flex-1 items-center justify-center bg-gray-50">
          <div className="max-w-md p-8 bg-white rounded-lg shadow-lg text-center">
            ...
            <h2 className="text-2xl font-bold mb-4 text-gray-800">
              Route Safety Feature Unavailable
            </h2>
            <p className="text-gray-600 mb-4">
              The route safety mapping feature requires a Google Maps API key.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded p-4 mb-4">
              <p className="text-sm text-gray-700">
                <strong>Good news:</strong> All other features work perfectly! You can still:
              </p>
              <ul className="text-left text-sm text-gray-700 mt-2 space-y-1">
                <li>✅ Report incidents</li>
                <li>✅ View all reports</li>
                <li>✅ Upload photos to IPFS</li>
                <li>✅ Store data on blockchain</li>
              </ul>
            </div>
            <p className="text-xs text-gray-500">
              If you want to enable this feature later, see <strong>GOOGLE_MAPS_SETUP.md</strong> for instructions (requires credit card for Google Cloud).
            </p>
            <a
              href="/"
